...
import { LayoutDashboard, Briefcase, UserCheck, Users, GraduationCap, FileSpreadsheet, Loader2 } from "lucide-react";
  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        setStats({ applications: 0, users: 0, services: 0, careers: 0, salaryGuideLeads: 0 });
      } finally {
        setLoading(false);
      }
    }

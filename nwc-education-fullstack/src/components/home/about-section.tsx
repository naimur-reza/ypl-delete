...
export async function AboutSection({ countryId }: AboutSectionProps) {
  ...
  // If countryId is provided, filter for country-specific or global stats
            ...
            {cards.map((card, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`
                    relative bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-gray-100
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-base font-medium text-gray-600 uppercase tracking-wider mt-2">
                      {card.subtitle}
                    </p>
                  </div>
                </div>

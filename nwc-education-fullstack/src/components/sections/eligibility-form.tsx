...
export default function EligibilityForm({ className, hideHeader = false }: EligibilityFormProps) {
  ...
  if (isSuccess) {
    return (
      <div className={cn("min-h-[400px] flex flex-col items-center justify-center text-center p-8 bg-white rounded-3xl shadow-xl border border-slate-100 w-full", className)}>
  ...
  return (
    <div className={cn("bg-white rounded-md shadow-xl border border-slate-100 overflow-hidden", className)}>
      {/* Header Bar */}
      {!hideHeader && (

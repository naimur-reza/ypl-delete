...
async function seed() {
  ...
  const roles = await Role.create([
    { name: "Software Engineer", slug: "software-engineer", departmentId: depts[0]._id, order: 1 },
    { name: "System Architect", slug: "system-architect", departmentId: depts[0]._id, order: 2 },
    { name: "HR Manager", slug: "hr-manager", departmentId: depts[1]._id, order: 1 },
    { name: "Financial Controller", slug: "financial-controller", departmentId: depts[2]._id, order: 1 },
  ]);
  ...
  await Career.create([
    {
      ...
      description: "Join a high-performance team building the next generation of SaaS solutions. Experience with React, Node.js, and Cloud Infrastructure is essential.",
      requirements: ["5+ years experience", "Strong React/Node skills", "AWS Certification preferred"],
    ...
    },
    {
      ...
      description: "Lead our recruitment strategy and build a world-class team. You will be responsible for end-to-end hiring and employer branding.",
      requirements: ["8+ years in recruitment", "Proven leadership experience", "Strong stakeholder management"],
    ...
    },
    {
      ...
      description: "Strategic leadership role overseeing all financial aspects of a growing wealth management firm.",
      requirements: ["Qualified Accountant (ACA/ACCA)", "15+ years experience", "Board-level experience"],
  ...
  await Service.create([
    {
      ...
      description: "Identifying and securing the best talent for your long-term success.",
      icon: "users",
      features: ["Candidate Screening", "Reference Checks", "Onboarding Support"],
      order: 1,
    },
    {
      title: "Executive Search",
      slug: "executive-search",
      description: "Confidential headhunting for leadership and C-suite positions.",
      icon: "target",
    ...
    },
    {
      ...
      description: "Flexible, project-based talent to bridge gaps or drive transformation.",
      icon: "clock",
      features: ["Rapid Deployment", "Experienced Consultants", "Short-term Experts"],
      order: 3,
    }
  ]);
  ...
  await Hero.create([
    {
      ...
      description: "We connect visionary companies with world-class professionals who drive innovation.",
    ...
    },
    {
      ...
      description: "Discover exclusive opportunities that align with your career ambitions and expertise.",
  ...
  const events = await Event.create([
    {
      ...
      description: "A comprehensive webinar on how AI and automation are reshaping the talent acquisition landscape. Learn from industry leaders about the future of hiring.",
      ...
      isActive: true,
      imageUrl: "https://images.unsplash.com/photo-1540575861501-7ad060e39fe1?w=800&q=80",
      capacity: 500,
  ...
  const firstJob = await Career.findOne({ slug: "senior-full-stack-developer" });
  if (firstJob) {
    await Application.create({
      ...
      coverLetter: "I am very excited about this role! I have 6 years of experience in React and Node.js.",
      status: "new",
    });
  }
  ...
  await SalaryGuideLead.create([
    {
      ...
      location: "London, UK",
      message: "I am interested in your 2026 salary benchmarks for the London area.",
      status: "New",
    }
  ]);
  ...
  const insights = await Insight.create([
    ...
    },
    {
      ...
      excerpt: "Technical skills get you the interview, but soft skills get you the job and the promotion. Learn which ones matter most.",
      content: "In an increasingly automated world, the skills that make us uniquely human are becoming our greatest professional assets. At YPL, we've analyzed thousands of job descriptions from the past year to identify the 'power skills' that employers are prioritizing.\n\n1. Emotional Intelligence (EQ)\n2. Adaptability & Cognitive Flexibility\n3. Critical Thinking\n4. Collaborative Problem Solving\n5. Digital Literacy\n6. Purpose-Driven Leadership\n7. Cross-Cultural Competency\n8. Analytical Thinking\n9. Active Listening\n10. Resilience\n\nDeveloping these skills requires more than just a certificate; it requires practice, feedback, and a commitment to lifelong learning.",
      author: "James Cooper",

...
const PAST_EVENTS: PastEvent[] = [
  {
    ...
    testimonials: [
      {
        name: "John Smith",
        message: "Amazing event! Met representatives from 20+ universities.",
        role: "Student",
      },
    ],
    summary:
      "Over 500 students attended our UK University Fair, meeting representatives from top institutions including Oxford, Cambridge, and Imperial College.",
  },
  {
    id: "2",
    ...
    summary:
      "Successfully hosted a webinar with 300+ participants exploring engineering programs in Australia and Canada.",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-3xl">
            Explore the success of our previous events through videos, photos,

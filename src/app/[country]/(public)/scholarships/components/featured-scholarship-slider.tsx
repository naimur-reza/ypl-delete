      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
          <div className="max-w-2xl">
            <span className="text-primary font-semibold tracking-wide text-sm uppercase mb-2 block">
        ...
        >
          {featuredScholarships.map((item) => (
            <div
              key={item.id}
              className="min-w-[340px] md:min-w-[380px] bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden snap-center group hover:shadow-2xl hover:border-primary/20 transition-all duration-300 flex flex-col"
            >
              {/* Image Header */}
              <div className="relative h-48 w-full overflow-hidden">
                ...
                />
                <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-primary shadow-xs uppercase tracking-wider">
              ...
              <div className="p-6 flex flex-col grow">
                ...
                <Link
                  ...
                  className="w-full mt-auto bg-slate-900 text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 group-hover:bg-primary transition-colors duration-300"
                >
                  Show Details

    ...
    <div className="group bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col md:flex-row items-stretch">
      ...
      <div className="relative w-full md:w-72 lg:w-80 h-48 md:h-auto shrink-0 overflow-hidden">
        <Image
          src={
            course.image ||
            "https://mie-global-te43fd.s3.amazonaws.com/static/images/BMSc-Medical-Education--Intercalated.original.webp"
          }
          alt={course.title}
          fill
      ...
      <div className="flex-1 p-5 md:p-6 flex flex-col">
        ...
        <div className="mt-6 flex flex-wrap items-end justify-between gap-4">
          <div className="flex gap-3">
            ...
            <div className="bg-[#EEF2FF] rounded-lg px-4 py-2 flex flex-col min-w-30">
            ...
            {/* Info Box 2: Duration */}
            <div className="bg-[#F0F9FF] rounded-lg px-4 py-2 flex flex-col min-w-30">

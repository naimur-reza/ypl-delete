    ...
    <section className="w-full py-14 bg-slate-50 relative overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          {/* Left Fade & Button */}
          <div
            className={`absolute left-0 top-0 bottom-0 w-32   z-20 flex items-center transition-opacity duration-300 ${
          ...
          {/* Right Fade & Button */}
          <div
            className={`absolute right-0 top-0 bottom-0 w-32   z-20 flex items-center justify-end transition-opacity duration-300 ${

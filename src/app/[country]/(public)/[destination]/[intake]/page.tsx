...
export async function generateMetadata({
  ...
  console.log("generateMetadata params:", { country, destination, intake });
  ...
  console.log("Intake page found:", !!intakeData);
...
export async function generateStaticParams() {
  ...
  console.log(`Generated ${params.length} static intake page params`);
  return params;
}

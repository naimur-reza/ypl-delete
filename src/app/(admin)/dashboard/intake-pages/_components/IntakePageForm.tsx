            ...
            <div className="space-y-4 border-t pt-4 border-border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <form.AppField name="heroCTALabel">
                  {(field) => (
                    <field.Input label="Button Label" placeholder="Apply Now" />
                  )}
                </form.AppField>
                ...
                <form.AppField name="heroCTAUrl">
                  {(field) => (
                    <div className="space-y-2">
                      ...
                      >
                        <option value="/apply-now">Apply Now Form</option>
              ...
              {/* Custom URL field - shown only if custom is selected */}
              {form.getFieldValue("heroCTAUrl") === "" && (
                <form.AppField name="heroCTAUrl">
                  {(field) => (
                    <field.Input
                      label="Custom URL"

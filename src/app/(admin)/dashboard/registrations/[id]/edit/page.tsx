  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch registration and destinations in parallel
        ...
        setForm({
          ...
          phone: regData.phone || "",
          city: regData.city || "",
          addressCountry: regData.addressCountry || "",
          studyDestination: regData.studyDestination || "",
          lastQualification: regData.lastQualification || "",
          englishTest: regData.englishTest || "",
          englishTestScore: regData.englishTestScore || "",
          additionalInfo: regData.additionalInfo || "",
          notes: regData.notes || "",
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Update registration for {registration.event?.title || "event"}
        </p>
      </div>

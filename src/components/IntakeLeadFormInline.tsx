...
type IntakeLeadFormInlineProps = {
...
export function IntakeLeadFormInline({
  destinations,
  defaultDestination = "",
  defaultCountry = "",
  countryId,
  ...
  headerSubtitle = "Fill the form below to check your eligibility. Our counselors will get back to you shortly.",
  singleColumn = false,
}: IntakeLeadFormInlineProps) {
    ...
    return (
      ...
      >
        ...
        <p className="text-slate-600 max-w-md">
          Thank you for your interest in the <strong>{intakeName}</strong>. 
          One of our expert counselors will review your profile and contact you within 24 hours.
        </p>
        <button

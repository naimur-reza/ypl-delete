 ...
 * <MarkdownContent content={blog.content} generateIds /> // For TOC support
 */
export function MarkdownContent({ content, className, generateIds = false }: MarkdownContentProps) {

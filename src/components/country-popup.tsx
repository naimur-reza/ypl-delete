...
export default function CountryPopup() {
  ...
  useEffect(() => {
    async function check() {
      ...
      if (supportedCountry) {
        // 5. If DB says for 'BD' the slug is 'bd', 
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full bg-linear-to-r from-blue-600 to-purple-600 text-white z-50 shadow-lg transition-all duration-300 ${isClosing ? 'opacity-0 -translate-y-full' : 'opacity-100 translate-y-0'
        }`}
    >
